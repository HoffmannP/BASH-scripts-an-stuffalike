BEGIN {
    ...
    curr_continent="null"
    curr_location="null"
    total_new_deaths_per_million=0
    max_people_fully_vaccinated_per_hundred=0
    print "continent","location","new_deaths_per_week_per_100000","people_fully_vaccinated_per_hundred"
}

{
    ...
    if (curr_location != location) {
        if ((days >= 7) && (total_new_deaths_per_million > 0) && (max_people_fully_vaccinated_per_hundred > 0)) {
            week_average_per_100000=7*total_new_deaths_per_million/days/10
    ...
    if (new_deaths_per_million > 0) {
        days+=1
        total_new_deaths_per_million+=new_deaths_per_million
    }
